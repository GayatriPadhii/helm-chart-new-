...
{{- printf "%s-%s" .Release.Name (include "your-chart.appName" .) | trunc 63 | trimSuffix "-" -}}
{{- end }}
...
{{- if and .Values.isSharedNamespace .Values.configMapName }}
...
{{- if and .Values.isSharedNamespace .Values.appdynamics.configMap }}
...
{{- if and .Values.isSharedNamespace .Values.secretConfig.existingSecretProviderClass }}
...
{{- if or .Values.isSharedNamespace .Values.removeEnvPrefix }}
